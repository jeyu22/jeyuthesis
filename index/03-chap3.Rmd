...
### Linear model 
```{r}
lm.child<- lm(bmi ~  decisions_eat +  run_away + cig + alcohol + physical_fight + real_age + wave, child_data) 
summary(lm.child)
```
