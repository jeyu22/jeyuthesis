...
$$ is approximately $\chi^2(q)$ [@lme_instatistics]. For a null hypothesis $H_0: L\beta = 0,$ the test statistic $G$ is $$(L\hat\beta)'[L(X'\widehat {Cov}(\hat\beta)X)^-L']^{-1}(L\hat\beta).$$ 
...
Sattherthwaite approximation was developed by @hrong-tai_fai_approximate_1996, with the F statistic following the form:
