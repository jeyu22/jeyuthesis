...
///// TBD
After fitting the model, we evaluate there robustness using Bradley's criterion that considers a test to robust if the empirical error rate is between .025 and .075.
