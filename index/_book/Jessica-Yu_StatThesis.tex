...
{\centering \includegraphics[width=0.49\linewidth]{Jessica-Yu_StatThesis_files/figure-latex/alcohol-1} 
...
\begin{center}\includegraphics[width=0.49\linewidth]{Jessica-Yu_StatThesis_files/figure-latex/unnamed-chunk-6-1} \end{center}
\begin{center}\includegraphics[width=0.49\linewidth]{Jessica-Yu_StatThesis_files/figure-latex/unnamed-chunk-6-2} \end{center}
...
\begin{center}\includegraphics[width=0.49\linewidth]{Jessica-Yu_StatThesis_files/figure-latex/unnamed-chunk-7-1} \end{center}
\begin{center}\includegraphics[width=0.49\linewidth]{Jessica-Yu_StatThesis_files/figure-latex/unnamed-chunk-7-2} \end{center}
...
\StringTok{  }\KeywordTok{mutate}\NormalTok{(}\DataTypeTok{age_at_start =} \KeywordTok{min}\NormalTok{(real_age))}
\KeywordTok{hist}\NormalTok{(child_data}\OperatorTok{$}\NormalTok{bmi, }\DataTypeTok{main =} \StringTok{"Distribution of BMI Across Sample"}\NormalTok{, }\DataTypeTok{xlab =} \StringTok{"BMI"}\NormalTok{)}
...
\StringTok{  }\KeywordTok{kbl}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Fixed Effects for Random Intercept Model Using KR"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_classic}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F)}
...
\StringTok{  }\KeywordTok{kbl}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Random Effects for Random Intercept Model Using KR"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_classic}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F)}
\KeywordTok{plot}\NormalTok{(intercept_model)}
...
\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\DataTypeTok{term =}\NormalTok{ S}\OperatorTok{$}\NormalTok{term, }\DataTypeTok{Satterthwaite_p.value =}\NormalTok{ S}\OperatorTok{$}\NormalTok{p.value, }\DataTypeTok{KR_p.value =}\NormalTok{ KR}\OperatorTok{$}\NormalTok{p.value)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kbl}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Comparison of Fixed Effects P-Values in Random Intercept Model"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_classic}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"HOLD_position"}\NormalTok{)}
\NormalTok{intercept_slope_model <-}\StringTok{ }\KeywordTok{lmer}\NormalTok{(bmi }\OperatorTok{~}\StringTok{ }\NormalTok{alcohol }\OperatorTok{+}\StringTok{ }\NormalTok{real_age }\OperatorTok{+}\StringTok{ }\NormalTok{wave }\OperatorTok{+}\StringTok{ }
\StringTok{                                }\NormalTok{(}\DecValTok{1} \OperatorTok{+}\StringTok{ }\NormalTok{wave }\OperatorTok{|}\StringTok{ }\NormalTok{AID), child_data)}
...
\StringTok{  }\KeywordTok{kbl}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Fixed Effects for Random Slope Model Using KR"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_classic}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"HOLD_position"}\NormalTok{)}

\KeywordTok{ranova}\NormalTok{(intercept_slope_model)}
\KeywordTok{drop1}\NormalTok{(intercept_slope_model)}

\KeywordTok{anova}\NormalTok{(intercept_model, intercept_slope_model, }\DataTypeTok{refit =}\NormalTok{ F)}
...
\KeywordTok{plot}\NormalTok{(intercept_slope_model)}
\KeywordTok{data.frame}\NormalTok{(}\KeywordTok{cbind}\NormalTok{(}\DataTypeTok{term =}\NormalTok{ S_s}\OperatorTok{$}\NormalTok{term, }\DataTypeTok{Satterthwaite_p.value =}\NormalTok{ S_s}\OperatorTok{$}\NormalTok{p.value, }
                 \DataTypeTok{KR_p.value =}\NormalTok{ KR_s}\OperatorTok{$}\NormalTok{p.value)) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kbl}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Comparison of Fixed Effects P-Values in Random Slope Model"}\NormalTok{) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{kable_classic}\NormalTok{(}\DataTypeTok{full_width =}\NormalTok{ F) }\OperatorTok{%>%}\StringTok{ }\KeywordTok{kable_styling}\NormalTok{(}\DataTypeTok{latex_options =} \StringTok{"HOLD_position"}\NormalTok{)}
\KeywordTok{library}\NormalTok{(here)}
\KeywordTok{library}\NormalTok{(tidyverse)}
\NormalTok{all_sim <-}\StringTok{ }\KeywordTok{readRDS}\NormalTok{(}\KeywordTok{here}\NormalTok{(}\StringTok{"SimulationData"}\NormalTok{, }\StringTok{"all_sim.rds"}\NormalTok{))}
