...
\begin{center}\includegraphics{Jessica-Yu_StatThesis_files/figure-latex/unnamed-chunk-12-1} \end{center}
\begin{verbatim}
   Linear mixed model fit by REML. t-tests use Kenward-Roger's
     method [lmerModLmerTest]
   Formula: bmi ~ 1 + decisions_eat + +(1 | AID) + wave
      Data: child_data
   ...
   -2.0385 -0.3124  0.0129  0.3542  3.1566 
   
   Random effects:
    Groups   Name        Variance Std.Dev.
    AID      (Intercept) 9.56     3.09    
    Residual             3.89     1.97    
   Number of obs: 36, groups:  AID, 12
   
   Fixed effects:
                  Estimate Std. Error     df t value Pr(>|t|)    
   (Intercept)      17.789      3.392 11.214    5.24  0.00026 ***
   decisions_eat1    0.402      3.441 10.000    0.12  0.90938    
   wave              1.318      0.403 23.000    3.27  0.00335 ** 
   ---
